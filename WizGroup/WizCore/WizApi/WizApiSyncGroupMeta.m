...
- (void) syncEnd
{
    [self postSyncGroupStatue:WizNMSyncGroupEnd];
    [self end];
    
}

- (void) postSyncGroupStatue:(NSString*)key
{
    NSMutableDictionary* userInfo = [NSMutableDictionary dictionaryWithCapacity:1];
    [WizNotificationCenter addGuid:self.kbGuid toUserInfo:userInfo];
    [[WizNotificationCenter defaultCenter] postNotificationName:key object:nil userInfo:userInfo];
}
...
- (BOOL) start
{
    ...
    [self postSyncGroupStatue:WizNMSyncGroupStart];
